...
public final class Repository_Impl implements Repository {
  ...
  public Repository_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR ABORT INTO `note` (`id`,`titulo`,`contenido`) VALUES (nullif(?, 0),?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getContenido());
      }
    };
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `note` SET `id` = ?,`titulo` = ?,`contenido` = ? WHERE `id` = ?";
      }
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpId,_tmpTitulo,_tmpContenido);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getByIdNote(final int id, final Continuation<? super Note> $completion) {
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpContenido;
            _tmpContenido = _cursor.getString(_cursorIndexOfContenido);
            _result = new Note(_tmpId,_tmpTitulo,_tmpContenido);
          } else {
            _result = null;
          }
          return _result;
